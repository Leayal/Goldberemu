...
public:
    ...
    static int get_file_wstr(std::string full_path, wchar_t* data, unsigned int max_length, unsigned int offset = 0);
    void setAppId(uint32 appid);
    static int store_file_data(std::string folder, std::string file, char *data, unsigned int length);
    static int store_file_wstr(std::string folder, std::string file, wchar_t* data, unsigned int length);
    ...
    int store_wstr(std::string folder, std::string file, wchar_t* data, unsigned int length);
    int store_wstr_settings(std::string file, wchar_t* data, unsigned int length);
    int get_wstr(std::string folder, std::string file, wchar_t* data, unsigned int max_length, unsigned int offset = 0);
    int get_wstr_settings(std::string file, wchar_t* data, unsigned int max_length);
