...
if exist "%VS_Base_Path%\Microsoft Visual Studio\2022\Professional\VC\Auxiliary\Build\vcvars64.bat" goto vs2022_pro
...
if exist "%VS_Base_Path%\Microsoft Visual Studio\2019\Professional\VC\Auxiliary\Build\vcvars64.bat" goto vs2019_pro
...
:vs2022_pro
call "%VS_Base_Path%\Microsoft Visual Studio\2022\Professional\VC\Auxiliary\Build\vcvars64.bat"
goto batend
